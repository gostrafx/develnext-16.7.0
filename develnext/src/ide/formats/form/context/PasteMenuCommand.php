    ...
    public function onExecute($e = null, AbstractEditor $editor = null)
    {
        ...
        if (UXClipboard::hasText()) {
            ...
            try {
                ...
                Notifications::warning('Can\'t Paste', 'Cannot paste copied information as DevelNext objects!');
                return;
            }
        } else {
            Notifications::warning('Can\'t Paste', 'Your clipboard is empty, no copied information to paste objects!');
        }
    }
